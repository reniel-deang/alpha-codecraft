<x-guest-layout>
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-6 py-8 md:min-h-screen mx-auto">
            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{ route('be.a.teacher') }}" method="POST"
                        ...
                        <div class="sm:flex sm:space-x-2">
                            ...
                            <div class="sm:w-5/12">
                                ...
                                <x-input type="text" id="contact_number" name="contact_number" placeholder="Contact Number"
                                    :invalid="$errors->has('contact_number')" :value="old('contact_number')" maxlength="11" 
                        ...
                        <div class="sm:flex sm:space-x-2">
                            ...
                            <div class="sm:w-1/2">
                                <x-input-label for="file" :invalid="$errors->has('file')" :label="__('ID/License')" />
                                <x-input-file id="file" name="file" placeholder="ID/License"
                                    :invalid="$errors->has('file')" required />
                        ...
                        <div class="grid gap-3 md:grid-cols-2">
                            ...
                            <div>
                                <x-input-label for="password_confirmation" :invalid="$errors->has('password')" :label="__('Confirm Password')" />
                                ...
                                <div class="ml-3 text-sm">
                                    <label for="terms" class="font-light text-gray-500 dark:text-gray-300">I accept
                                        ...
                                        <a class="font-medium text-primary-600 hover:underline dark:text-primary-500"
                                            href="{{ route('terms') }}">Terms and Conditions</a></label>
                                </div>
                            </div>
                            <button type="submit"
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            ...
                            <a href="{{ route('login') }}" class="font-medium text-primary-600 hover:underline dark:text-primary-200">Login here</a>
                            Or
                            <a href="{{ route('register') }}" class="font-medium text-primary-600 hover:underline dark:text-primary-200">Sign up as Student</a>
                        </p>
                    </form>
                </div>
            </div>
