    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-6">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-xl font-bold text-gray-900 dark:text-white">Your Classes</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="w-1/4">
                            <button id="dropdown-button-{{ $classroom->id }}" data-dropdown-toggle="dropdown-{{ $classroom->id }}"
                                ...
                                <ul class="py-2" aria-labelledby="dropdown-button-{{ $classroom->id }}">
                                    <li>
                                        <button data-link="{{ route('classes.update', $classroom) }}"
                                            ...
                                            data-name="{{ $classroom->name }}" data-subject="{{ $classroom->subject }}"
                                            data-description="{{ $classroom->description }}">
                                            Edit
                                        </button>
                                    </li>
                                    <li>
                                        <button data-id="{{ $classroom->id }}" data-link="{{ route('classes.delete', $classroom) }}"
                    ...
                    <h6 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">{{ $classroom->subject }}</h6>
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 break-words">
                        {{ $classroom->description }}
                    </p>
                    <a href="{{ route('classes.view', $classroom) }}"
                        class="absolute bottom-5 right-5 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Go to Class
